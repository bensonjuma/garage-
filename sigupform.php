...
<div style="font-size:2em; color:#E5B840; padding:255px 20px; font-family: 'bebas_neueregular'; "> 
	...
	<table>
		...
		<tr>
		<td style=" position:absolute; top:150%; left:35%;"><input type="text" name="plateno" placeholder="House Number" size="50%" style="height:30px; border-radius:45px;  border-style:none; font-size:15px; "></td>
		</tr>
				...
				<div class="col_1_of_4 span_1_of_4">
					<h3>Location</h3>
					       <ul>
						  	 ...
						  	 <li><span>Telephone :</span> 079-2218741</li>
